...
def get_undertime_triplet(
   ...
   examples:
   Josh = (0,0,20)      means Josh is under-scheduled 20 hours during the 3rd pay period.
...
def get_all_undertime_triplets(schid: Schedule | str
...
def get_sum_sch_undertime(schid: Schedule | str
                          ) -> int:
