...
employee_patterns = [
    ...
    path("v2/employee/<name>/generate-schedule/<sch>/",views.EMPLOYEE.EmployeeScheduleView.as_view(), name="v2-employee-schedule"),
    ...
    path('empl/shift-tallies/<empId>/kdeplot/', EmpViews.tallyPlotDataGenerator, name="emusr-empl-kdeplot"),
