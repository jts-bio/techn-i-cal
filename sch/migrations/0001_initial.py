# Generated by Django 4.1.1 on 2022-11-30 06:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('conflicting_slots', models.ManyToManyField(default=None, null=True, to='sch.slot')),
                ...
                ('shift', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='slots', to='sch.shift')),
                ('week', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='slots', to='sch.week')),
                ('workday', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='slots', to='sch.workday')),
            ],
